                    ...
                    Row(
                      ...
                      const  SizedBox(
                        ...
                        Obx(() => BouncingWidget(
                              ...
                              child: Genres(
                                  txt: "Followed",
                                  color: (sideMenuController.isFolling.value)
                                      ? Colors.purple
                                      : Colors.transparent,
                                  heigth: 38,
                                  width: 100),
              ...
              child: Container(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Songs_widget(
                          nbr: sideMenuController.data_songs.value[index]
                              ["nbr"],
                          title: sideMenuController.data_songs.value[index]
                              ["title"],
                          artistname: sideMenuController.data_songs.value[index]
                              ["Artist name"],
                          time: sideMenuController.data_songs.value[index]
                              ["time"]);
                    }),
              )),
        ],
